class VixenProfilesController < ApplicationController
  ...
  def vixen_profile_params
    params.require(:vixen_profile).permit(:gender, :birthday, :location, :height_feet, :height_inches, :weight, :bust, :waist, :hips, :cup, :dress, :ethnicity, :experience, :rate, :rate_per, :travel, :hair_makeup, :wardrobe, :profile_pic, :bio, ethnicity: [], work: [])
  end
end
